radio.onReceivedNumber(function (receivedNumber) {
    ...
    i2cSchleife(true, qwiicmotor.getReceivedNumber(NumberFormat.UInt8LE, qwiicmotor.eOffset.z0), Math.round(Math.map(qwiicmotor.getReceivedNumber(NumberFormat.UInt8LE, qwiicmotor.eOffset.z1), 0, 255, 135, 45)))
})
